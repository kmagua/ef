 ...
 public function rules()
{
    return [
        ...
        [['document_name', 'document_upload_path', 'keywords', 'upload_date', 'publish_status', 'published_date', 'document_date', 'status', 'updated_at', 'deleted_at', 'category'], 'safe'],
    ];
}
    ...
    ->andFilterWhere(['category' => $this->category]) // Fixed category filtering
    ->andFilterWhere(['like', 'publish_status', $this->publish_status])
    ->andFilterWhere(['like', 'status', $this->status]);

$query->orderBy(['financial_year' => SORT_DESC]); // Corrected ordering syntax
